...
class _Cfg:
    ...
    output_dir  = "/work/pi_nwycoff_umass_edu/hang/auto/runs/idea017/design001"
    resume      = ""

    # Temporal context
    in_channels  = 8          # 8-channel input: [RGB_t, D_t, RGB_{t-5}, D_{t-5}]
    temporal_mode = "stack"   # informational only
