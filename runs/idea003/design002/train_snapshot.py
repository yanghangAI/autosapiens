...
class _Cfg:
    ...
    output_dir  = "/work/pi_nwycoff_umass_edu/hang/auto/runs/idea003/design002"
    resume      = ""
    ...
    # Loss weights
    lambda_uv           = 0.2
    depth_start_weight  = 0.0
    depth_target_weight = 0.1
    depth_warmup_epochs = 5
...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_m = train_one_epoch(model, train_loader, optimizer, scaler, device, epoch + 1, args,
                                  iter_logger=iter_logger, depth_weight=current_depth_weight)
