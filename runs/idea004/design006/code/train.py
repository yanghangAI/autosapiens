"""Training entry point for SapiensPose3D — idea004/design006.

Constant Decay LLRD (gamma=0.85, unfreeze_epoch=10):
...
- Epochs 0-9: blocks 0-11 + embeddings frozen (excluded from optimizer)
- Epoch 10+: all blocks unfrozen, optimizer rebuilt with 26 param groups
"""
