...
from infra import PELVIS_IDX, RGB_MEAN, RGB_STD, DEPTH_MAX_METERS, FLIP_PAIRS
...
def build_train_transform(out_h: int, out_w: int, scale_jitter: bool = True) -> Compose:
    return Compose([CropPerson(out_h, out_w), RandomHorizontalFlip(p=0.5), SubtractRoot(), ToTensor()])
