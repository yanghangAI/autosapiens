"""Sapiens-based RGBD pose estimation model -- design002: Learned Layer Weights.

Extracts last 4 ViT blocks, applies softmax-weighted sum with 4 learnable scalars.
"""
...
class SapiensBackboneRGBD(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> list[torch.Tensor]:
        """Return list of 4 feature maps from last 4 ViT blocks."""
