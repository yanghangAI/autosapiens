...
class _Cfg:
    ...
    output_dir  = "/work/pi_nwycoff_umass_edu/hang/auto/runs/idea019/design004"
    resume      = ""
    ...
    # Joint group embeddings (informational)
    group_emb_init   = 0.0   # zero-init so training starts identical to baseline
    num_joint_groups = 4     # torso, arms, legs, extremities
