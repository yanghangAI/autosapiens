...
design002: EMA with Warmup (decay ramps from ~0 to 0.9995).
Uses momentum-style warmup: decay_t = min(target, (1+step)/(10+step)).
Validates on EMA model. No architecture, loss, or optimizer changes.
"""
