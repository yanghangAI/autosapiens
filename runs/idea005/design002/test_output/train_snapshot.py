...
def main():
    ...
    # Print final val body MPJPE as a single float to stdout (required by Builder spec)
    if val_m:
        final_val_mpjpe_body = val_m["val_mpjpe_body"]
    else:
        final_val_mpjpe_body = float("nan")
    print(f"FINAL_VAL_MPJPE_BODY: {final_val_mpjpe_body}")
