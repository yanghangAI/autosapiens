...
from infra import NUM_JOINTS, SAPIENS_ARCHS, _interp_pos_embed, DEPTH_MAX_METERS
...
class Pose3DHead(nn.Module):
    """Full 3D Volumetric Heatmap head (design003: 40×24×16, Integral Pose Regression)."""
    ...
    def __init__(self, in_channels, num_joints=NUM_JOINTS, hidden_dim=256,
        ...
        # Register coordinate buffers: flatten over H*W*D
    ...
    def forward(self, feat: torch.Tensor) -> dict[str, torch.Tensor]:
        ...
        # joints_out stores [u_norm, v_norm, d_abs] — converted to (x,y,z) in train.py
...
class SapiensPose3D(nn.Module):
    ...
    def __init__(self, arch="sapiens_0.3b", img_size=(640, 384), num_joints=NUM_JOINTS,
        ...
        self.head = Pose3DHead(in_channels=SAPIENS_ARCHS[arch]["embed_dim"],
                               ...
                               dropout=head_dropout, heatmap_h=heatmap_h, heatmap_w=heatmap_w,
                               num_depth_bins=num_depth_bins)
