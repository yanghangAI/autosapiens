...
class _Cfg:
    ...
    output_dir  = "/work/pi_nwycoff_umass_edu/hang/auto/runs/idea016/design004"
    resume      = ""
    ...
    heatmap_w    = 24
    lambda_z_joint = 1.0
    lambda_hm    = 0.1   # weight on Gaussian heatmap MSE loss
    hm_sigma     = 2.0   # Gaussian sigma in grid cells
