...
user_name = 'hang'
save_npy_path = '/home/hang/data/NTU-RGBD/npy_skeletons_s018_to_s032/'
load_txt_path = '/home/hang/data/NTU-RGBD/nturgbd_skeletons_s018_to_s032/'
missing_file_path = 'toytest/missing.txt'
...
if __name__ == '__main__':
    ...
    for ind, each in enumerate(datalist):
        ...
        try:
            ...
            print('error in reading file: {}'.format(each))
        # raise ValueError()
    _end_toolbar()

#S024C002P067R001A101
#S019C001P041R001A066