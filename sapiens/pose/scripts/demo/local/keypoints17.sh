...
OUTPUT="/home/${USER}/repos/sapiens/pose/Outputs/vis/itw_videos/reel1"
...
# MODEL_NAME='sapiens_1b'; CHECKPOINT=$SAPIENS_CHECKPOINT_ROOT/pose/checkpoints/sapiens_1b/sapiens_1b_coco_wholebody_best_coco_wholebody_AP_727_torchscript.pt2
